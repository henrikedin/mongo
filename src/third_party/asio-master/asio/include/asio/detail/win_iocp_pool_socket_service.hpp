...
#ifndef ASIO_DETAIL_WIN_IOCP_POOL_SOCKET_SERVICE_HPP
#define ASIO_DETAIL_WIN_IOCP_POOL_SOCKET_SERVICE_HPP
...
#include "asio/detail/win_iocp_pool_socket_service_base.hpp"
...
class win_iocp_pool_socket_service :
  public service_base<win_iocp_pool_socket_service<Protocol> >,
  public win_iocp_pool_socket_service_base
{
public:
  // The protocol type.
  ...
  struct implementation_type :
    win_iocp_pool_socket_service_base::base_implementation_type
  {
    // Default constructor.
    implementation_type()
  ...
  // Constructor.
  win_iocp_pool_socket_service(asio::io_pool_context& io_context)
    : service_base<win_iocp_pool_socket_service<Protocol> >(io_context),
      win_iocp_pool_socket_service_base(io_context)
  {
  }
  ...
  typename Protocol::socket accept(implementation_type& impl,
      io_pool_context* peer_io_context, endpoint_type* peer_endpoint,
      asio::error_code& ec)
  {
  ...
  void async_accept(implementation_type& impl,
      asio::io_pool_context* peer_io_context,
      endpoint_type* peer_endpoint, Handler& handler)
  {
    // Allocate and construct an operation to wrap the handler.
...
#endif // ASIO_DETAIL_WIN_IOCP_POOL_SOCKET_SERVICE_HPP
