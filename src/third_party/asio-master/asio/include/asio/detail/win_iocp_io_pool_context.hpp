...
#ifndef ASIO_DETAIL_WIN_IOCP_IO_POOL_CONTEXT_HPP
#define ASIO_DETAIL_WIN_IOCP_IO_POOL_CONTEXT_HPP
...
class win_iocp_io_pool_context
  : public execution_context_service_base<win_iocp_io_pool_context>,
    public thread_context
{
public:
  // Constructor. Specifies a concurrency hint that is passed through to the
  // underlying I/O completion port.
  ASIO_DECL win_iocp_io_pool_context(asio::execution_context& ctx,
...
#endif // ASIO_DETAIL_WIN_IOCP_IO_POOL_CONTEXT_HPP
