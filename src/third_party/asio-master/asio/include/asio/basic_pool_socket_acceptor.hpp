...
#ifndef ASIO_BASIC_POOL_SOCKET_ACCEPTOR_HPP
#define ASIO_BASIC_POOL_SOCKET_ACCEPTOR_HPP
...
#include "asio/basic_io_pool_object.hpp"
...
#  include "asio/detail/win_iocp_pool_socket_service.hpp"
#  define ASIO_SVC_POOL_T detail::win_iocp_pool_socket_service<Protocol>
# else
...
class basic_pool_socket_acceptor
  : ASIO_SVC_ACCESS basic_io_pool_object<ASIO_SVC_POOL_T>,
    public socket_base
{
public:
  /// The type of the executor associated with the object.
  typedef io_pool_context::executor_type executor_type;

  /// The native representation of an acceptor.
#if defined(GENERATING_DOCUMENTATION)
  typedef implementation_defined native_handle_type;
#else
  typedef typename ASIO_SVC_POOL_T::native_handle_type native_handle_type;
#endif
   ...
   * acceptor.
   */
  explicit basic_pool_socket_acceptor(asio::io_pool_context& io_context)
    : basic_io_pool_object<ASIO_SVC_POOL_T>(io_context)
  {
  }
   ...
   */
  basic_pool_socket_acceptor(asio::io_pool_context& io_context,
   ...
   */
  basic_pool_socket_acceptor(basic_pool_socket_acceptor&& other)
    : basic_io_pool_object<ASIO_SVC_POOL_T>(std::move(other))
  {
  }
   ...
   * constructed using the @c basic_socket_acceptor(io_context&) constructor.
   */
  basic_pool_socket_acceptor& operator=(basic_pool_socket_acceptor&& other)
  {
    basic_io_object<ASIO_SVC_POOL_T>::operator=(std::move(other));
    return *this;
  }

  // All socket acceptors have access to each other's implementations.
  template <typename Protocol1 ASIO_SVC_TPARAM1>
  friend class basic_pool_socket_acceptor;
  ...
  typename enable_if<is_convertible<Protocol1, Protocol>::value,
	  basic_pool_socket_acceptor>::type& operator=(
        basic_socket_acceptor<Protocol1 ASIO_SVC_TARG1>&& other)
  {
    basic_socket_acceptor tmp(std::move(other));
	basic_io_pool_object<ASIO_SVC_POOL_T>::operator=(std::move(tmp));
    return *this;
  }
   ...
   */
  asio::io_pool_context& get_io_context()
  {
    return basic_io_pool_object<ASIO_SVC_POOL_T>::get_io_context();
  }
   ...
   * to dispatch handlers. Ownership is not transferred to the caller.
   */
  asio::io_pool_context& get_io_service()
  {
    return basic_io_pool_object<ASIO_SVC_POOL_T>::get_io_service();
  }
  ...
  {
    return basic_io_pool_object<ASIO_SVC_POOL_T>::get_executor();
  }
#endif // defined(ASIO_ENABLE_OLD_SERVICES)
   ...
   * @endcode
   */
  typename Protocol::socket accept(asio::io_pool_context& io_context)
  {
    asio::error_code ec;
    typename Protocol::socket peer(
        this->get_service().accept(this->get_implementation(),
   ...
   */
  typename Protocol::socket accept(
      asio::io_pool_context& io_context, asio::error_code& ec)
  {
  ...
  ASIO_INITFN_RESULT_TYPE(MoveAcceptHandler,
      void (asio::error_code, typename Protocol::socket))
  async_accept(asio::io_pool_context& io_context,
  ...
  typename Protocol::socket accept(endpoint_type& peer_endpoint)
  {
    ...
    typename Protocol::socket peer(
        this->get_service().accept(this->get_implementation(),
          static_cast<asio::io_pool_context*>(0), &peer_endpoint, ec));
    asio::detail::throw_error(ec, "accept");
    return peer;
  }
   ...
   */
  typename Protocol::socket accept(
      asio::io_pool_context& io_context, endpoint_type& peer_endpoint)
  {
    asio::error_code ec;
    typename Protocol::socket peer(
        this->get_service().accept(this->get_implementation(),
...
#if !defined(ASIO_ENABLE_OLD_SERVICES)
# undef ASIO_SVC_POOL_T
#endif // !defined(ASIO_ENABLE_OLD_SERVICES)

#endif // ASIO_BASIC_POOL_SOCKET_ACCEPTOR_HPP
