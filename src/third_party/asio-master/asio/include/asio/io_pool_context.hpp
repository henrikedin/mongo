...
#ifndef ASIO_IO_POOL_CONTEXT_HPP
#define ASIO_IO_POOL_CONTEXT_HPP
...
namespace detail {
  ...
  typedef class win_iocp_io_pool_context io_pool_context_impl;
...
{
private:
  typedef detail::io_pool_context_impl impl_type;
#if defined(ASIO_HAS_IOCP)
...
public:
   ...
   */
  ASIO_DECL explicit io_pool_context(int concurrency_hint);
...
class io_pool_context::executor_type
{
public:
  /// Obtain the underlying execution context.
	io_pool_context& context() const ASIO_NOEXCEPT;
...
private:
  friend class io_pool_context;

  // Constructor.
  explicit executor_type(io_pool_context& i) : io_context_(i) {}

  // The underlying io_context.
  io_pool_context& io_context_;
};
...
public:
   ...
   */
  explicit work(asio::io_pool_context& io_context);
...
private:
  ...
  detail::io_pool_context_impl& io_context_impl_;
};
#endif // !defined(ASIO_NO_DEPRECATED)

/// Base class for all io_context services.
class io_pool_context::service
...
protected:
   ...
   */
  ASIO_DECL service(asio::io_pool_context& owner);
...
class service_pool_base
  : public asio::io_pool_context::service
{
public:
  static asio::detail::service_id<Type> id;

  // Constructor.
  service_pool_base(asio::io_pool_context& io_context)
    : asio::io_pool_context::service(io_context)
  {
  }
};

template <typename Type>
asio::detail::service_id<Type> service_pool_base<Type>::id;
...
#include "asio/impl/io_pool_context.hpp"
#if defined(ASIO_HEADER_ONLY)
# include "asio/impl/io_pool_context.ipp"
#endif // defined(ASIO_HEADER_ONLY)

// If both io_pool_context.hpp and strand.hpp have been included, automatically
...
#endif // ASIO_IO_POOL_CONTEXT_HPP
