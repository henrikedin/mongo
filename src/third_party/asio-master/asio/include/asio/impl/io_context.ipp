...
io_context::io_context(bool use_win_thread_pool)
  : impl_(add_impl(new impl_type(*this, ASIO_CONCURRENCY_HINT_DEFAULT, use_win_thread_pool)))
{
}

io_context::io_context(int concurrency_hint, bool use_win_thread_pool)
