...
#ifndef ASIO_BASIC_STREAM_POOL_SOCKET_HPP
#define ASIO_BASIC_STREAM_POOL_SOCKET_HPP
...
class basic_stream_pool_socket
...
public:
   ...
   */
  explicit basic_stream_pool_socket(asio::io_pool_context& io_context)
   ...
   */
  basic_stream_pool_socket(asio::io_pool_context& io_context,
   ...
   */
  basic_stream_pool_socket(basic_stream_pool_socket&& other)
   ...
   * constructed using the @c basic_stream_socket(io_context&) constructor.
   */
  basic_stream_pool_socket& operator=(basic_stream_pool_socket&& other)
  {
  ...
  basic_stream_pool_socket(
	  basic_stream_pool_socket<Protocol1 ASIO_SVC_TARG1>&& other,
  ...
  typename enable_if<is_convertible<Protocol1, Protocol>::value,
	  basic_stream_pool_socket>::type& operator=(
		  basic_stream_pool_socket<Protocol1 ASIO_SVC_TARG1>&& other)
  {
    basic_socket<Protocol ASIO_SVC_TARG>::operator=(std::move(other));
    return *this;
...
#endif // ASIO_BASIC_STREAM_POOL_SOCKET_HPP
