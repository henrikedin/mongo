    ...
    for (int i = 0; i < kMaxAttempts; ++i) {
        ...
        switch (nextInput.getStatus()) {
            case GetNextResult::ReturnStatus::kAdvanced: {
                ...
                LOGV2_DEBUG(20704, 1, "$sample encountered duplicate document: {nextInput_getDocument_toString}", "nextInput_getDocument_toString"_attr = nextInput.getDocument().toString());
