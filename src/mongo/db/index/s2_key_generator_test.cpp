...
TEST(S2KeyGeneratorTest, GetS2KeysFromArrayOfNonGeoSubobjectsWithArrayValues) {
    ...
    ASSERT_TRUE(areKeysetsEqual(expectedKeys, actualKeys));
    assertMultikeyPathsEqual(MultikeyPaths{{0U, 1U}, boost::container::flat_set<size_t>{}}, actualMultikeyPaths);
}
...
TEST(S2KeyGeneratorTest, GetS2KeysFromMultiPointInGeoField) {
    ...
    ASSERT_TRUE(areKeysetsEqual(expectedKeys, actualKeys));
    assertMultikeyPathsEqual(MultikeyPaths{boost::container::flat_set<size_t>{}, {0U}}, actualMultikeyPaths);
}
...
TEST(S2KeyGeneratorTest, CollationAppliedToNonGeoStringFieldAfterGeoField) {
    ...
    ASSERT_TRUE(areKeysetsEqual(expectedKeys, actualKeys));
    assertMultikeyPathsEqual(MultikeyPaths{boost::container::flat_set<size_t>{}, boost::container::flat_set<size_t>{}},
                             actualMultikeyPaths);
}
...
TEST(S2KeyGeneratorTest, CollationAppliedToAllNonGeoStringFields) {
    ...
    assertMultikeyPathsEqual(
        MultikeyPaths{boost::container::flat_set<size_t>{}, boost::container::flat_set<size_t>{}, boost::container::flat_set<size_t>{}},
        actualMultikeyPaths);
}
...
TEST(S2KeyGeneratorTest, CollationAppliedToStringsInAllArrays) {
    ...
    ASSERT_TRUE(areKeysetsEqual(expectedKeys, actualKeys));
    assertMultikeyPathsEqual(MultikeyPaths{boost::container::flat_set<size_t>{}, {0U}, {0U}}, actualMultikeyPaths);
}
...
TEST(S2KeyGeneratorTest, EmptyArrayForLeadingFieldIsConsideredMultikey) {
    ...
    ASSERT_TRUE(areKeysetsEqual(expectedKeys, actualKeys));
    assertMultikeyPathsEqual(MultikeyPaths{{0U}, boost::container::flat_set<size_t>{}}, actualMultikeyPaths);
}
...
TEST(S2KeyGeneratorTest, SingleElementTrailingArrayIsConsideredMultikey) {
    ...
    ASSERT_TRUE(areKeysetsEqual(expectedKeys, actualKeys));
    assertMultikeyPathsEqual(MultikeyPaths{{1U}, boost::container::flat_set<size_t>{}}, actualMultikeyPaths);
}
