...
public:
    ...
    virtual void getKeys(SharedBufferFragmentBuilder& allocator, const BSONObj& obj,
                         GetKeysMode mode,
...
protected:
     ...
     * information that must be stored in a reserved keyspace within the index.
     */
    virtual void doGetKeys(SharedBufferFragmentBuilder& allocator, const BSONObj& obj,
                           GetKeysContext context,
                           KeyStringSet* keys,
                           KeyStringSet* multikeyMetadataKeys,
                           MultikeyPaths* multikeyPaths,
