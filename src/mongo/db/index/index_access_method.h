...
public:
    ...
    virtual void getKeys(SharedBufferFragmentBuilder& allocator,
                         const BSONObj& obj,
                         GetKeysMode mode,
...
public:
    ...
    void getKeys(SharedBufferFragmentBuilder& allocator,
                 const BSONObj& obj,
                 GetKeysMode mode,
                 GetKeysContext context,
                 KeyStringSet* keys,
...
protected:
     ...
     * information that must be stored in a reserved keyspace within the index.
     */
    virtual void doGetKeys(SharedBufferFragmentBuilder& allocator,
                           const BSONObj& obj,
                           GetKeysContext context,
                           KeyStringSet* keys,
                           KeyStringSet* multikeyMetadataKeys,
