...
Status repairCollection(OperationContext* opCtx,
    ...
    auto collection = CollectionCatalog::get(opCtx).lookupCollectionByNamespaceForMetadataWrite(opCtx, nss);
    ...
    // repairRecordStore.
    collection = CollectionCatalog::get(opCtx).lookupCollectionByNamespaceForMetadataWrite(opCtx, nss);
