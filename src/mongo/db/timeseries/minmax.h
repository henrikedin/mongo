...
public:
    ...
    public:
        ...
        // subelement. Only instantiated when we've depleated our allowed linear search depth.
    ...
    public:
         ...
         * from start to end with a maximum search threashold. When the maximum search threashold is
