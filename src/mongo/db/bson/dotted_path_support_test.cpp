...
void dumpArrayComponents(const boost::container::flat_set<size_t>& arrayComponents, StringBuilder* sb) {
    *sb << "[ ";
    bool firstIteration = true;
...
void assertArrayComponentsAreEqual(const boost::container::flat_set<size_t>& expectedArrayComponents,
                                   const boost::container::flat_set<size_t>& actualArrayComponents) {
...
TEST(ExtractAllElementsAlongPath, NestedObjectWithScalarValue) {
    ...
    boost::container::flat_set<size_t> actualArrayComponents;
    ...
    assertArrayComponentsAreEqual(boost::container::flat_set<size_t>{}, actualArrayComponents);
}
...
TEST(ExtractAllElementsAlongPath, NestedObjectWithEmptyArrayValue) {
    ...
    assertArrayComponentsAreEqual(boost::container::flat_set<size_t>{1U}, actualArrayComponents);
}
