...
public:
    MobileKVHarnessHelper() : _dbPath("mobile_kv_engine_harness") {
        addMobileStorageOptionDefinitions(&optionenvironment::startupOptions);
        optionenvironment::OptionsParser parser;
        std::vector<std::string> args;
        std::map<std::string, std::string> env;
        parser.run(
            optionenvironment::startupOptions, args, env, &optionenvironment::startupOptionsParsed);
        storeMobileStorageOptionDefinitions(optionenvironment::startupOptionsParsed);
