...
public:
     ...
     * catalog updates are atomic. Subsequent calls overrides any previously registered change.
     * Change registered with this function will commit after the commit changes registered with
     * registerChange and rollback will run before the rollback changes registered with
     * registerChange.
     *
