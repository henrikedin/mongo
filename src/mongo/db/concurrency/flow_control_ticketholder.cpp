...
void FlowControlTicketholder::refreshTo(int numTickets) {
    ...
    LOGV2_DEBUG(4, "Refreshing tickets. Before: {} Now: {}", "tickets"_attr = _tickets, "numTickets"_attr = numTickets);
    _tickets = numTickets;
    _cv.notify_all();
}
...
void FlowControlTicketholder::getTicket(OperationContext* opCtx,
    ...
    LOGV2_DEBUG(4, "Taking ticket. Available: {}", "tickets"_attr = _tickets);
    if (_tickets == 0) {
