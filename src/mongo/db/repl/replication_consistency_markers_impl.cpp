...
void ReplicationConsistencyMarkersImpl::ensureFastCountOnOplogTruncateAfterPoint(
    ...
    LOGV2_DEBUG(3, "Updating cached fast-count on collection {} in case an unclean shutdown caused it to become incorrect.", "oplogTruncateAfterPointNss"_attr = _oplogTruncateAfterPointNss);
