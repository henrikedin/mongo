...
public:
    ...
    static std::shared_ptr<Collection> getForTxn(OperationContext* opCtx, const NamespaceStringOrUUID& nss);
    static std::shared_ptr<Collection> getForTxn(OperationContext* opCtx, const NamespaceString& nss);
