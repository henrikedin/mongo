...
std::shared_ptr<Collection> getCollectionForCompact(OperationContext* opCtx,
                                    Database* database,
    ...
    auto collection = collectionCatalog.lookupCollectionByNamespace(opCtx, collectionNss);
...
StatusWith<int64_t> compactCollection(OperationContext* opCtx,
    ...
    auto collection = getCollectionForCompact(opCtx, database, collectionNss);
