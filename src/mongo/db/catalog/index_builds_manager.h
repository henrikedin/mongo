...
public:
    ...
    Status resumeBuildingIndexFromBulkLoadPhase(OperationContext* opCtx, const Collection* collection, const UUID& buildUUID);
     ...
     */
    Status checkIndexConstraintViolations(OperationContext* opCtx, const Collection* collection, const UUID& buildUUID);
