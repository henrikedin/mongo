...
public:
     ...
     * A managed Collection pointer may be returned as nullptr, which indicate a drop.
     ...
     * A managed Collection pointer may be returned as nullptr, which indicate drop or rename.
     * If the returned boolean is false then the Collection will always be nullptr.
     */
