...
namespace mongo {
	...
	AuthzSessionExternalStateEmbedded::AuthzSessionExternalStateEmbedded(AuthorizationManager* authzManager)
    : AuthzSessionExternalStateServerCommon(authzManager) {}
	AuthzSessionExternalStateEmbedded::~AuthzSessionExternalStateEmbedded() {}

void AuthzSessionExternalStateEmbedded::startRequest(OperationContext* opCtx) {
...
bool AuthzSessionExternalStateEmbedded::shouldIgnoreAuthChecks() const {
...
bool AuthzSessionExternalStateEmbedded::serverIsArbiter() const {
