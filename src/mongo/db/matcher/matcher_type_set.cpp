...
const StringMap<BSONType> MatcherTypeSet::kJsonSchemaTypeAliasMap = {
    {static_cast<std::string>(JSONSchemaParser::kSchemaTypeArray), BSONType::Array},
    {static_cast<std::string>(JSONSchemaParser::kSchemaTypeBoolean), BSONType::Bool},
    {static_cast<std::string>(JSONSchemaParser::kSchemaTypeNull), BSONType::jstNULL},
    {static_cast<std::string>(JSONSchemaParser::kSchemaTypeObject), BSONType::Object},
    {static_cast<std::string>(JSONSchemaParser::kSchemaTypeString), BSONType::String},
};
