...
TEST(logComponentSettingsTest, MinimumLogSeverity) {
...
TEST(logComponentSettingsTest, ShouldLogDefaultLogComponentOnly) {
    LogComponentSettings settings;
...
// componentA: 2
TEST(logComponentSettingsTest, ShouldLogSingleComponent) {
    LogComponentSettings settings;
...
// componentA: 2
// componentB: 0
TEST(logComponentSettingsTest, ShouldLogMultipleComponentsConfigured) {
    LogComponentSettings settings;
...
TEST(logComponentTest, Hierarchy) {
...
TEST(logComponentTest, DottedNameOldTest) {
    // Default -> ComponentD -> ComponentE
...
TEST(logComponentTest, DottedName) {
    struct {
        LogComponent lc;
        StringData expect;
    } const kSpecs[] = {
