...
void assertEquals(const std::string& json,
    ...
    if (bad) {
        ::mongo::LOGV2(22219, "want:{expected_jsonString} size: {expected_objsize}", "expected_jsonString"_attr = expected.jsonString(), "expected_objsize"_attr = expected.objsize());
        ::mongo::LOGV2(22220, "got :{actual_jsonString} size: {actual_objsize}", "actual_jsonString"_attr = actual.jsonString(), "actual_objsize"_attr = actual.objsize());
        ::mongo::LOGV2(22221, "{expected_hexDump}", "expected_hexDump"_attr = expected.hexDump());
        ::mongo::LOGV2(22222, "{actual_hexDump}", "actual_hexDump"_attr = actual.hexDump());
        ::mongo::LOGV2(22223, "{msg}", "msg"_attr = msg);
        ::mongo::LOGV2(22224, "orig json:{json}", "json"_attr = json);
    }
    ASSERT(!bad);
}
