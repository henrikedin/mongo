...
TEST(TransportLayerASIO, HTTPRequestGetsHTTPError) {
    ...
    MONGO_BOOST_LOG << "Waiting for response";
    ...
    MONGO_BOOST_LOG << "Received response: \"" << httpResp << "\"";
