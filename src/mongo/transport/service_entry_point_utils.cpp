    ...
    try {
        ...
        if (limits.rlim_cur > kStackSize) {
            ...
            if (failed) {
                ...
                LOGV2_WARNING(22632, "pthread_attr_setstacksize failed: {ewd}", "ewd"_attr = ewd);
            }
        } else if (limits.rlim_cur < 1024 * 1024) {
            LOGV2_WARNING(22633, "Stack size set to {limits_rlim_cur_1024}KB. We suggest 1MB", "limits_rlim_cur_1024"_attr = (limits.rlim_cur / 1024));
        }
        ...
        if (failed) {
            LOGV2(22631, "pthread_create failed: {errnoWithDescription_failed}", "errnoWithDescription_failed"_attr = errnoWithDescription(failed));
