...
public:
    ...
    */
    Socket(double so_timeout = 0, log::LogSeverity logLevel = log::LogSeverity::Log());
    ...
    log::LogSeverity getLogLevel() const {
        return _logLevel;
    }
    void setLogLevel(log::LogSeverity ll) {
        _logLevel = ll;
    }
...
#endif
    log::LogSeverity _logLevel;  // passed to LOG() when logging errors
