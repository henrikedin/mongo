...
public:
    ...
    explicit LogV2Appender(logv2::LogDomain* domain, bool warnOnLargeMessages, logv2::LogTag extraTag = logv2::LogTag::kNone)
        : _domain(domain), _warnOnLargeMessages(warnOnLargeMessages), _tag(extraTag) {}
