...
class RamLogSink : public boost::log::sinks::basic_formatted_sink_backend<char, boost::log::sinks::concurrent_feeding> {
private:
    //! Base type
    typedef boost::log::sinks::basic_formatted_sink_backend<char,
                                                            boost::log::sinks::concurrent_feeding> base_type;
...
static boost::shared_ptr<boost::log::sinks::unlocked_sink<RamLogSink>> create_ramlog_sink(
    RamLog* ramlog) {
