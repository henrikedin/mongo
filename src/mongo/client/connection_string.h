...
public:
    ...
    std::unique_ptr<DBClientNetwork> connect(StringData applicationName,
                                             std::string& errmsg,
    ...
    public:
        ...
        virtual std::unique_ptr<DBClientNetwork> connect(const ConnectionString& c,
                                                         std::string& errmsg,
                                                         double socketTimeout) = 0;
    };
