...
//    // dataReceived() throws because the command reported failure. However, we can't return it
//    yet,
...
//    verify(cursorId && batch.pos == batch.objs.size());
//    uassert(50851, "Cannot have limit for exhaust query", !haveLimit);
//    Message response;
//    verify(_client);
//    if (!_client->recv(response, _lastRequestId)) {
//        uasserted(50852, "recv failed while exhausting cursor");
//    }
//    dataReceived(response);
//}
//
...
//}
//
// DBClientCursor::DBClientCursorNetwork(DBClientNetwork* client,
//                               const std::string& ns,
//                               const BSONObj& query,
//                               int nToReturn,
//                               int nToSkip,
